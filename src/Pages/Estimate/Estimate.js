...
const Estimate = () => {
  ...
  console.log(userEstimateProcess);

  const nextProcess = () => {
    currentEstimate === 3 && setUserEstimateProcess('주행거리');
    currentEstimate === 4 && setUserEstimateProcess('추가옵션');
    currentEstimate === 5 && setUserEstimateProcess('추가입력');
    currentEstimate === 6 && setUserEstimateProcess('사진등록');
    currentEstimate === 7 && setUserEstimateProcess('개인정보');
